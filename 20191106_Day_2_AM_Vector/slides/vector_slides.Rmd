...
---
## Usage
- Filter for any district that *intersects* this fire
```{r}
res <- fire_districts %>% 
  filter(st_intersects(geometry, big_fires, sparse = FALSE)[,2])
...
## Usage
- Did any transmission lines cross any fires in BC in 2017

```{r}
all_crosses <- fires_2017[lines, , op = st_crosses]

all_join <- st_join(fires_2017, lines, left = FALSE)

all_crosses <- fires_2017[lines, , op = st_intersects]
