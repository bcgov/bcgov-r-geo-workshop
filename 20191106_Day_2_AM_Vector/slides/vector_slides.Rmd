...
```{r cache=TRUE}
railways <- bcdc_get_data("WHSE_BASEMAPPING.GBA_RAILWAY_TRACKS_SP")
...
Create an `sf` object from railways containing only track segments 
longer than 5 km
...
## Your turn: Find the total area of each NR region
