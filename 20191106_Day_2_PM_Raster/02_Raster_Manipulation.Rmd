...
Another way to extract the data we want is to `mask` out the areas we dont want. This function created a new raster that has the same values as a defined raster, except for the cells that are NA. These cells will become NA. This works with either another raster or vector data as a sp object. 
