...
```{r create a hillshade map, results = "hide"}
...
ggplot() +
  ...
  geom_raster(data = hs_df,
              aes(x = x, y = y, alpha = layer)) +  scale_fill_gradientn(colours = terrain.colors(10)) +  
...
```{r zonal stats demo, results = "hide"}
#zonal calculations 
...
Credits & Licensing
The content presented here is drawn from a number of sources including: 
